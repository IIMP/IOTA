...
public interface IotaNodeApi {
    ...
    /**
     * Tip selection which returns trunkTransaction and branchTransaction for compass.
     * The input value is the latest coordinator milestone, as provided through the getNodeInfo API call.
     * @throws Exception 
     */
    GetTransactionsToApproveResponsecompass getTransactionsToApprovecompass(IotaGetTransactionsToApproveRequestcompass request) throws ArgumentException;
    GetStorageResponse getStorage(IotaGetStorageRequest request) throws ArgumentException;
