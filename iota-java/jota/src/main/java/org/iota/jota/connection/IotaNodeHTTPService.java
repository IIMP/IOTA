...
public interface IotaNodeHTTPService {
    ...
    @Headers({CONTENT_TYPE_HEADER, USER_AGENT_HEADER})
    @POST("./")
    Call<GetTransactionsToApproveResponsecompass> getTransactionsToApprovecompass(@Body IotaGetTransactionsToApproveRequestcompass request);

    @Headers({CONTENT_TYPE_HEADER, USER_AGENT_HEADER})
    @POST("./")
    Call<GetStorageResponse> getStorage(@Body IotaGetStorageRequest request);
    /**
