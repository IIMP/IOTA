...
import org.iota.jota.dto.request.IotaGetTransactionsToApproveRequestcompass;
import org.iota.jota.dto.request.IotaGetStorageRequest;
...
import org.iota.jota.dto.response.GetStorageResponse;
...
public class HttpConnector implements Connection {
    ...
    @Override
    public GetTransactionsToApproveResponsecompass getTransactionsToApprovecompass(IotaGetTransactionsToApproveRequestcompass request) throws ArgumentException {
        final Call<GetTransactionsToApproveResponsecompass> res = service.getTransactionsToApprovecompass(request);
        return wrapCheckedException(res).body();
    }
    @Override
    public GetStorageResponse getStorage(IotaGetStorageRequest request) throws ArgumentException{
        final Call<GetStorageResponse> res = service.getStorage(request);
        return wrapCheckedException(res).body();
    }
