 ...
 */
package com.iota.iri.vm.config;
...
// import com.iota.iri.vm.config.blockchain.OlympicConfig;
import com.iota.iri.vm.config.net.*;
import com.iota.iri.vm.core.Genesis;
import com.iota.iri.vm.core.genesis.GenesisConfig;
import com.iota.iri.vm.core.genesis.GenesisJson;
import com.iota.iri.vm.core.genesis.GenesisLoader;
...
public class SystemProperties {
    ...
    public static SystemProperties getSpringDefault(boolean flag) {
    ...
    public String databaseDir() {
        return databaseDir == null ? config.getString("user.dir") : databaseDir;
    }
