 ...
 * @since 08.09.2014
 */
public interface Repository extends com.iota.iri.vm.facade.Repository{
    ...
    AccountMap getAccountMap(byte[] addr);
    ...
    boolean aliasAccount(byte[] oldAddr,byte[] EVMaddr,byte[] newAddr);
