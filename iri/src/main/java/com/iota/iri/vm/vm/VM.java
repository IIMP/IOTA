...
import com.iota.iri.vm.program.Stack;
...
import static com.iota.iri.vm.vm.OpCode.*;
import static com.iota.iri.vm.vm.VMUtils.getSizeInWords;
...
public class VM {
    ...
    public void step(Program program) {
        ...
        try {
            ...
            long gasCost = 0;//op.getTier().asInt();
            long gasBefore = 0;//program.getGasLong();
            ...
            // System.out.println("Switching op");
            // Execute operation
            switch (op) {
                /**
                ...
                case LOG4: {
                    ...
                    // System.out.println("logInfo:"+logInfo.hashCode());
                    program.step();
                }
                break;
                case MLOAD: {
                ...
                break;
                case SSTORE: {
                    // System.out.println("Entering SStore");
                    // if (program.isStaticCall()) throw new Program.StaticCallModificationException();

                    DataWord addr = program.stackPop();
                    // System.out.println("      contract: "+program.getOwnerAddress().shortHex());

                    // System.out.println("      addr: "+addr.shortHex());
                    DataWord value = program.stackPop();
                    
                    int AKVHash = (program.getOwnerAddress().asString()+addr.asString()+value.asString()).hashCode();
                    program.getResult().getStorageAKVHash().add(Integer.toString(AKVHash));
                    System.out.println("VM===========>added result storageAKVHash:"+Integer.toString(AKVHash));

                    // System.out.println("      value: "+value.bigIntValue());
                ...
                case STATICCALL: {
                    ...
                    if (!op.callIsStateless()) {
                        // System.out.println("TouchedAccount:"+codeAddress.getLast20Bytes().hashCode());
