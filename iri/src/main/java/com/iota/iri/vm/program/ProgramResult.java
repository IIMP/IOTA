...
import com.iota.iri.vm.vm.CallCreate;
...
public class ProgramResult {
    ...
    private Set<String> storageAKVHash;
    ...
    public Set<String> getStorageAKVHash(){
        if(storageAKVHash==null){
            storageAKVHash = new HashSet<>();
        }
        return storageAKVHash;
    }
