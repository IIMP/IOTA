...
public class InternalTransaction extends EVMTransaction {
    ...
    public InternalTransaction(byte[] parentHash, int deep, int index, byte[] nonce, DataWord gasPrice, DataWord gasLimit,
        ...
        super(nonce, nullToEmpty(sendAddress), receiveAddress, nullToEmpty(value), nullToEmpty(data));
    ...
    public byte[] getEncoded() {
        if (rlpEncoded == null) {
            ...
            this.rlpEncoded = RLP.encodeList(
                    ...
                    // RLP.encodeElement(Bi),
                    // RLP.encodeElement(BigInteger.ZERO),
