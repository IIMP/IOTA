 ...
 */
package com.iota.iri.vm.config.blockchain;
...
// import com.iota.iri.vm.core.Block;
...
import com.iota.iri.vm.vm.GasCost;
import com.iota.iri.vm.vm.OpCode;
...
public class Eip150HFConfig implements BlockchainConfig, BlockchainNetConfig {
    ...
    @Override
    public long getTransactionCost(EVMTransaction tx) {
        return parent.getTransactionCost(tx);
    }

    @Override
    public boolean acceptTransactionSignature(EVMTransaction tx) {
