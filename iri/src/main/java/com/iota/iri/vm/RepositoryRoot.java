...
public class RepositoryRoot extends RepositoryImpl {
    ...
    public RepositoryRoot(final Source<byte[], byte[]> stateDS, byte[] root) {
        ...
        SourceCodec.BytesKey<AccountMap, byte[]> accountMapCodec = new SourceCodec.BytesKey<>(stateTrie, Serializers.AccountMapSerializer);
        final ReadWriteCache.BytesKey<AccountMap> accountMapCache = new ReadWriteCache.BytesKey<>(accountMapCodec, WriteCache.CacheType.SIMPLE);
